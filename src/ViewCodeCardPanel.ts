...
export class ViewCodeCardPanel {
  /**
   * Track the currently panel. Only allow a single panel to exist at a time.
   */
  public static currentPanel: ViewCodeCardPanel | undefined;

  public static readonly viewType = "view-code-card";
  ...
  public static createOrShow(extensionUri: vscode.Uri, userInfo: UserInfo) {
    const column = vscode.window.activeTextEditor
      ? vscode.window.activeTextEditor.viewColumn
      : undefined;

    // If we already have a panel, show it.
    if (ViewCodeCardPanel.currentPanel) {
      ViewCodeCardPanel.currentPanel._panel.reveal(column);
      ViewCodeCardPanel.currentPanel._userInfo = userInfo;
      ViewCodeCardPanel.currentPanel._update();
      return;
    }

    // Otherwise, create a new panel.
    const panel = vscode.window.createWebviewPanel(
      ViewCodeCardPanel.viewType,
      "VSinder",
    ...
    ViewCodeCardPanel.currentPanel = new ViewCodeCardPanel(
      panel,
      extensionUri,
      userInfo
    );
  ...
  public static kill() {
    ViewCodeCardPanel.currentPanel?.dispose();
    ViewCodeCardPanel.currentPanel = undefined;
  }
